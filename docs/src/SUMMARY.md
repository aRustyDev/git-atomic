...
- [ADR-001: Adopt local-first design](./adr/adr-001-adopt-local-first-design.md)
- [ADR-002: Use gix for git operations](./adr/adr-002-use-gix-for-git-operations.md)
...
[Blog / Lessons Learned](../blog/README.md)
